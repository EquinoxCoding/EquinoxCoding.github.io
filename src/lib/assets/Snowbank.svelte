...
<svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 944.76 736" style="--color: {color}">
    <defs>
        <style>
            .cls-1 {
                fill: var(--color);
